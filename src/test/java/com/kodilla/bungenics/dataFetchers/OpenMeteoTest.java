...
import com.kodilla.bungenics.dataFetchers.OpenMeteo.LocationNotFoundException;
...
class OpenMeteoTest {
    ...
    @Test
    void shouldThrow() {
        // Now accurately expects LocationNotFoundException when an invalid location is passed
